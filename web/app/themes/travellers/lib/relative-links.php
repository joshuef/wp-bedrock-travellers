...
// $MAKE RELATIVE
//------------------------------------//
function trv_relative_links( $url )
{
  ...
  $relative_url_filters = array(
      ...
      'wp_get_attachment_url', // Attachment link
  ...
  add_filter( $relative_url_filters, 'trv_relative_links' );
  }
...
//       if( $filter == 'style_loader_src' )
//       {
//         var_dump('THIS IS STYLES');
//         var_dump($filter);
//       }
